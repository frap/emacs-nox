...
*** Font
#+BEGIN_SRC emacs-lisp
(defvar gas-fonts '(("Iosevka" . 13) ("Hack" . 13) ("DejaVu Sans Mono" . 11)
...
(use-package company :ensure
  ...
  (setq-hook! prog-mode
    company-backends '((:separate company-dabbrev-code company-capf company-yasnippet company-go)))
...
^^    _F_: file dwim          ^^                     ^^    _b_: switch to buffer      _x_: remove known project      _s-p_/_p_: switch to other project
